...
// ====================================================================
// 5. دوال مساعدة إضافية (مسح المفكرة) - NEW
// ====================================================================
function clearLocalReply() {
    if (confirm("هل أنت متأكد من أنك تريد مسح الرد المحفوظ من جهازك؟ لن يمكن استعادته.")) {
        // حذف العنصر المخزن باستخدام مفتاح التخزين
        localStorage.removeItem(STORAGE_KEY);
        
        // مسح مربع الإدخال مباشرة في الصفحة
        const textarea = document.getElementById('userInput');
        if (textarea) {
            textarea.value = '';
        }

        alert("تم مسح الرد المحفوظ بنجاح!");
        console.log("تم مسح الرد المحفوظ من localStorage.");
    }
}
